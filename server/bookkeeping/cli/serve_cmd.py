...
from server.bookkeeping.cli.common import fail, resolve_project_root
from server.web.app import create_app, resolve_frontend_dist
...
def register(app: typer.Typer) -> None:
    ...
    def serve_command(
        ...
        frontend_dist = resolve_frontend_dist(resolved_project_root)
